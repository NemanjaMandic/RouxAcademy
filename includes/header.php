		...
		<header class="clearfix">
			...
			<nav class="navbar navbar-default">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
					<a href="#" class="dropdown-toggle" type="button" id="dropdownMenu" data-toggle="dropdown">Artists<span class="caret"></span></a>
					  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
					      ...
					      <li><a tabindex="-1" href="artists.php#Jonathan_Ferrar">Jonathan Ferrar</a></li>
      					  ...
      					  <li><a tabindex="-1" href="artists.php#Hillary_Goldwynn">Hillary Goldynn</a></li>
      					  ...
      					  <li><a tabindex="-1" href="artists.php#Constante_Smith">Constante Smith</a></li>
